...
class drawThread : public ofThread {
...
private:
    ...
    void threadedFunction()
    {
        while (isThreadRunning()) {
            ...
            if (!bFirstLoopFinished)
                bFirstLoopFinished = true;
        }
    }
};
...
private:
    ...
    static void accelSimulationMethod(void *nul);
    static void threadedLoopOnce();
    ...
    static void sendInitToPd();
    static void sendExitToPd();
    ...
    bool bHotkeyEnabled;
    bool bHoldingFnKey;
    bool bAccelSimEnabled;
    bool bMultiTouchSimEnabled;
    bool bMultiTouchSimScheduled;
    ofVec2f touches[OFELIA_MAX_TOUCHES];
    bool bWindowOwner;
    ...
    static t_clock *accelSimulationClock;
    static const int fnKey;
