...
function ofelia.new()
  ...
  elseif #args ~= 0 then
    log:error("requires 8 or 12 creation arguments")
  end
end

function ofelia.bang()
  ofDrawCurve(p0.x, p0.y, p0.z, p1.x, p1.y, p1.z, p2.x, p2.y, p2.z, p3.x, p3.y, p3.z)
  return nil
end
...
function ofelia.p0(fv)
  ...
  elseif #fv == 3 then
    ...
    log:error("'p0' requires 2 or 3 arguments")
  end
end
...
function ofelia.p1(fv)
  ...
  elseif #fv == 3 then
    ...
    log:error("'p1' requires 2 or 3 arguments")
  end
end
...
function ofelia.p2(fv)
  ...
  elseif #fv == 3 then
    ...
    log:error("'p2' requires 2 or 3 arguments")
  end
end
...
function ofelia.p3(fv)
  ...
  elseif #fv == 3 then
    ...
    log:error("'p3' requires 2 or 3 arguments")
  end
end