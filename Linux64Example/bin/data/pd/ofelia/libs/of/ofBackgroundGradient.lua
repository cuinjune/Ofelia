local log = pdLog("ofBackgroundGradient")
...
function ofelia.new()
  ...
  elseif #args == 9 then
    ...
    ofelia.mode(args[9])
  elseif #args ~= 0 then
    log:error("requires 2, 3, 4, 5, 6, 7, 8 or 9 creation arguments")
  end
end
...
function ofelia.c1(iv)
  ...
  elseif #iv == 4 then
    ...
    log:error("'c1' requires 1, 2, 3 or 4 arguments")
  end
end
...
function ofelia.c2(iv)
  ...
  elseif #iv == 4 then
    ...
    log:error("'c2' requires 1, 2, 3 or 4 arguments")
  end
end
