...
function ofelia.allocate(av)
  ...
  elseif #av == 4 then
    ...
    log:error("'allocate' requires 2, 3 or 4 arguments")
    return
  end
...
function ofelia.clearColorBuffer(av)
  ...
  elseif #av == 5 then
    ...
    log:error("'clearColorBuffer' requires 4 or 5 arguments")
  end
end
...
function ofelia.createAndAttachDepthStencilTexture(iv)
  ...
  elseif #iv == 5 then
    ...
    log:error("'createAndAttachDepthStencilTexture' requires 3 or 5 arguments")
  end
end
