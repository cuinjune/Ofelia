...
void ofeliaWindow::createWindow()
{
    ...
    /* store the initial device orientation then set to default orientation */
    const UIInterfaceOrientation orientation = [UIApplication sharedApplication].statusBarOrientation;
    
    if (initWindowWidth <= initWindowHeight) { //if default orientation is portrait
        
        switch (orientation) {
                
            case UIInterfaceOrientationPortrait:
                ofeliaWindow::initialDeviceOrien = WINDOW_ORIENTATION_DEFAULT;
                break;
            case UIInterfaceOrientationLandscapeLeft: //same as UIDeviceOrientationLandscapeRight
                ofeliaWindow::initialDeviceOrien = WINDOW_ORIENTATION_RIGHT;
                break;
            case UIInterfaceOrientationPortraitUpsideDown:
                ofeliaWindow::initialDeviceOrien = WINDOW_ORIENTATION_INVERT;
                break;
            case UIInterfaceOrientationLandscapeRight: //same as UIDeviceOrientationLandscapeLeft
                ofeliaWindow::initialDeviceOrien = WINDOW_ORIENTATION_LEFT;
                break;
            default:
                break;
        }
    ...
    else { //if default orientation is landscape
    ...
    retinaScale = static_cast<int>(scale);
    bFirstLoop = true;
    bFirstUpdate = true;
    bWindowOwner = true;
