...
**Application**: Create windows, start the OF application and check info about it's state.
...
**Graphics**: 2D graphics, images and typography.
...
**3d**: Three-dimensional graphics classes and functions.
...
**Math**: Vector math classes, geometry utils and other mathematical functions.
...
**Utils**: Filesystem, threading, popup windows and other utilities.
...
Other features are available using [ofelia] object which allows you to code Lua on a Pd patch or create such abstractions yourself.
