...
function ofelia.new()
  ...
  elseif #args == 7 then
    ...
    headSize = args[7]
  elseif #args ~= 0 then
    log:error(objName .. " : requires 4, 5, 6 or 7 creation arguments")
  end
end
...
function ofelia.from(fv)
  ...
  elseif #fv == 3 then
    ...
    log:error(objName .. " : 'from' requires 2 or 3 arguments")
  end
end
...
function ofelia.to(fv)
  ...
  elseif #fv == 3 then
    ...
    log:error(objName .. " : 'to' requires 2 or 3 arguments")
  end
end
