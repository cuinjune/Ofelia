local log = pdLog("ofTrueTypeFontSettings")
...
function ofelia.set(av)
  if #av == 2 then
    M.trueTypeFontSettings = ofTrueTypeFontSettings(av[1], av[2])
  elseif #av == 6 then
    M.trueTypeFontSettings = ofTrueTypeFontSettings(av[1], av[2])
    M.trueTypeFontSettings.antialiased = av[3] ~= 0
    M.trueTypeFontSettings.contours = av[4] ~= 0
    M.trueTypeFontSettings.simplifyAmt = av[5]
    M.trueTypeFontSettings.dpi = av[6]
  else
