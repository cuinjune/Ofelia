local objName = "ofDrawBitmapStringHighlight"
local log = pdLog()
...
function ofelia.new()
  ...
  elseif #args ~= 0 then
    log:error(objName .. " : requires 3, 9 or 11 creation arguments")
  end
end
...
function ofelia.background(iv)
  ...
  elseif #iv == 4 then
    ...
    log:error(objName .. " : 'background' requires 1, 2, 3 or 4 arguments")
  end
end
...
function ofelia.foreground(iv)
  ...
  elseif #iv == 4 then
    ...
    log:error(objName .. " : 'foreground' requires 1, 2, 3 or 4 arguments")
  end
end