...
function ofelia._set(av)
  ...
  elseif #av == 6 then
    ...
    log:error(objName .. " : 'set' requires 2 or 6 arguments")
  end
end
...
function ofelia.addRanges(s)
  ...
  elseif alphabet == "Cyrillic" then
    ...
    log:error(objName .. " : unknown alphabet : " .. alphabet)
    return
  end
...
function ofelia.addRange(s)
  ...
  elseif range == "OtherAdditionalSymbols" then
    ...
    log:error(objName .. " : unknown range : " .. range)
    return
  end
